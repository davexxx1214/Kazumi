...
class RuleCard extends StatelessWidget {
  ...
  KeyEventResult _handleTrailingKeyEvent(FocusNode node, KeyEvent event) {
    if (event is KeyDownEvent &&
  ...
  Widget build(BuildContext context) {
    ...
    final actions = trailing == null
        ...
        : Focus(
            ...
            skipTraversal: true,
            onKeyEvent: trailingFocusNode == null
                ? null
                : _handleTrailingKeyEvent,
            child: trailing!,
          );
