...
class _PluginViewPageState extends State<PluginViewPage> {
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return RuleCard(
                        ...
                        onTap: () {
                          ...
                          } else if (focusNodes != null &&
                              !_updatingNames.contains(plugin.name)) {
  ...
  Widget _menu(Plugin plugin, int index, {FocusNode? focusNode}) => MenuAnchor(
